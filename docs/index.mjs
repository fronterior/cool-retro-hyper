...
var package_default = {
  ...
  scripts: {
    ...
    "build:docs": "tsup src/docs/index.ts --format esm --watch --out-dir ./docs",
...
var hyperPromptTextLength = hyperPromptText.replaceAll(/\x1B.*?m/g, "").length;
var HyperASCIILogo = `
   \u2592\u2592\u2592\u2592\u2592\u2592\u2592\u2592\u2592\u2592\u2592\u2592\u2592\u2592\u2592\u2592\u2592\u2592\u2592\u2592\u2592\u2592\u2592\u2592\u2592\u2592  
 \u2592\u2592\u2592\u2591                      \u2591\u2592\u2592\u2592
  ...
  switch (keyCode) {
    ...
    case 27:
      ...
      if (eventKey === "ArrowUp") {
        ...
        historyCursor -= 1;
        const nextText2 = inputHistory[historyCursor];
        inputText = nextText2;
        cursor = nextText2.length;
        term.write(
          `\r${hyperPromptText}${nextText2}${" ".repeat(term.cols - hyperPromptText.length - nextText2.length)}\x1B[${cursorY + 2};${hyperPromptTextLength + cursor + 1}H`
        );
      }
      if (eventKey === "ArrowDown") {
        ...
        cursor = nextText2.length;
        term.write(
          `\r${hyperPromptText}${nextText2}${" ".repeat(term.cols - hyperPromptText.length - nextText2.length)}\x1B[${cursorY + 1};${hyperPromptTextLength + cursor + 1}H`
        );
        return;
      }
